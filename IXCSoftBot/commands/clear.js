...
module.exports = {
  name: "clear",
  description: "Limpar a queue de músicas",
  usage: "",
  permissions: {
  ...
  SlashCommand: {
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      player.queue.clear();
      await client.sendTime(interaction, "✅ | **A queue de músicas foi limpa!**");
    },
  },
};
